...
with st.sidebar:
    st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaTYhUoVWSsnrI91HExENwqNyWAgX61B0-ebKJ-tbQbLTz-eMea5yi5YlzTtILf8mGgTI&usqp=CAU",width=300)


    SELECT = option_menu(
        menu_title = None,
        options = ["Home","About","Basic insights","Search"],
